...
<div id="modalEndSessionLogout" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.75); backdrop-filter:blur(6px); -webkit-backdrop-filter:blur(6px); z-index:99999; align-items:center; justify-content:center;">
    <div style="background:#1e293b; border:1px solid #334155; border-top:4px solid #ef4444; border-radius:12px; max-width:440px; width:90%; padding:1.75rem; box-shadow:0 25px 50px -12px rgba(0,0,0,0.6); text-align:center; font-family: system-ui, -apple-system, sans-serif;">
        ...
        <div style="display:flex; gap:0.75rem; justify-content:center;">
            <button type="button" onclick="closeEndSessionLogoutModal()" style="padding:0.65rem 1.2rem; background:transparent; border:1px solid #475569; color:#e2e8f0; border-radius:6px; font-weight:600; font-size:0.9rem; cursor:pointer; flex:1; transition: background 0.2s;">
                Cancel / Stay
            </button>
            <?php
            ...
            ?>
            <a href="<?php echo $logout_path; ?>" style="padding:0.65rem 1.2rem; background:#ef4444; color:#fff; border-radius:6px; font-weight:600; font-size:0.9rem; text-decoration:none; display:inline-flex; align-items:center; justify-content:center; gap:0.4rem; flex:1; transition: background 0.2s;">
